...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$a(val = call$d(fn, input))) return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$a(val = call$d(fn, input))) return val;
  if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$a(val = call$d(fn, input))) return val;
...
var NEW_ITERATOR_PROTOTYPE = !isObject$4(IteratorPrototype$2) || fails$7(function () {
  var test = {};
...
if (!isCallable$8(IteratorPrototype$2[ITERATOR$8])) {
  defineBuiltIn$5(IteratorPrototype$2, ITERATOR$8, function () {
    return this;
  });
}
  ...
  if (anyNativeIterator) {
    ...
    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
      if (getPrototypeOf$1(CurrentIteratorPrototype) !== IteratorPrototype) {
        ...
        } else if (!isCallable$6(CurrentIteratorPrototype[ITERATOR$7])) {
          defineBuiltIn$4(CurrentIteratorPrototype, ITERATOR$7, returnThis);
        }
      }
...
var bind$6 = uncurryThis$8(uncurryThis$8.bind);
...
var safeGetBuiltIn = function (name) {
  ...
  var descriptor = getOwnPropertyDescriptor$2(global$7, name);
...
var decodeURIComponent$1 = global$7.decodeURIComponent;
...
defineBuiltIn$2(URLSearchParamsPrototype, ITERATOR$3, URLSearchParamsPrototype.entries, { name: 'entries' });
...
if (!USE_NATIVE_URL && isCallable$5(Headers$1)) {
...
var ChariotConsole$1 = {};

Object.defineProperty(ChariotConsole$1, "__esModule", { value: true });
...
const callerFnc = function (config) {
    return new ChariotConsole(config);
};
ChariotConsole$1.default = callerFnc;

var EventStreamer$1 = {};

Object.defineProperty(EventStreamer$1, "__esModule", { value: true });
...
EventStreamer.emitter = new events_1.EventEmitter();
EventStreamer$1.default = new EventStreamer();

var Expr = {};

var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(_tslib);
 ...
 */
const encode$2 = (str) => encodeURIComponent(str)
...
class Expressions {
    ...
    whenAndroid(callback, notCallback) {
        if (core_1.Capacitor.getPlatform() === 'android') {
            callback();
        }
        else if (notCallback) {
            notCallback();
    ...
    whenIos(callback, notCallback) {
        if (core_1.Capacitor.getPlatform() === 'ios') {
            callback();
        }
        else if (notCallback) {
            notCallback();
...
Expr.default = new Expressions();

Object.defineProperty(lib, "__esModule", { value: true });
lib.Expr = lib.EventStreamer = lib.ChariotConsole = void 0;
const ChariotConsole_1 = ChariotConsole$1;
lib.ChariotConsole = ChariotConsole_1.default;
const EventStreamer_1 = EventStreamer$1;
lib.EventStreamer = EventStreamer_1.default;
const Expr_1 = Expr;
lib.Expr = Expr_1.default;
...
var WithBootedClient$1 = {};

Object.defineProperty(WithBootedClient$1, "__esModule", { value: true });
class WithBootedClient {
}
WithBootedClient$1.default = WithBootedClient;

Object.defineProperty(IAM$1, "__esModule", { value: true });
IAM$1.IAM = IAM$1.User = void 0;
const tslib_1$2 = require$$0$1;
const jwt_decode_1 = require$$1;
const Lib$1 = lib;
const WithBootedClient_1$2 = WithBootedClient$1;
const storageName$1 = '@user';
const USER_SIGNIN_EVENT = 'user.signin';
const USER_SIGNOUT_EVENT = 'user.signout';
class User$2 {
    constructor(accessToken) {
        this.accessToken = accessToken;
        this.payload = (0, jwt_decode_1.default)(accessToken);
        localStorage.setItem(storageName$1, accessToken);
    }
    static fromToken(accessToken) {
        return new User$2(accessToken);
    }
    static fromCache() {
        const accessToken = localStorage.getItem(storageName$1);
        if (accessToken) {
            return User$2.fromToken(accessToken);
        }
        return;
    }
    getInfo() {
        return {
            identifier: this.payload.primarysid,
            provider: this.payload.groupsid,
            name: this.payload.unique_name,
            avatar: this.payload.avatar,
            email: this.payload.email,
            locale: 'es',
            roles: this.payload.roles,
            scopes: this.payload.scope,
            created_at: new Date(this.payload.iat).toISOString(),
        };
    }
    getToken() {
    ...
    getProvider() {
        return this.payload.groupsid;
    }
    hasRole(key) {
        return this.payload.roles.includes(key);
    }
    hasRoles() {
        return this.payload.roles.length > 0;
    }
    hasScope(key) {
        return this.payload.scope.findIndex((s) => s.startsWith(key)) > -1;
    }
    getScope(key) {
        return this.payload.scope.filter((s) => s.startsWith(key)).map((s) => s.replace(`${key}:`, ''));
    }
    signOut() {
        localStorage.removeItem(storageName$1);
        Lib$1.EventStreamer.emit(USER_SIGNOUT_EVENT);
    }
}
IAM$1.User = User$2;
class IAM extends WithBootedClient_1$2.default {
    constructor() {
        super(...arguments);
        this.USER_SIGNIN_EVENT = USER_SIGNIN_EVENT;
        this.USER_SIGNOUT_EVENT = USER_SIGNOUT_EVENT;
    }
    ...
    isAuthenticated() {
        return localStorage.getItem(storageName$1) !== null;
    }
    getUser() {
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        return User$2.fromCache();
    }
    authenticate(raw) {
        User$2.fromToken(raw.access_token);
        Lib$1.EventStreamer.emit(USER_SIGNIN_EVENT);
    }
}
IAM$1.IAM = IAM;
IAM$1.default = new IAM();

var Settings = {};

Object.defineProperty(Settings, "__esModule", { value: true });
Settings.SettingsClient = void 0;
const tslib_1$1 = require$$0$1;
const WithBootedClient_1$1 = WithBootedClient$1;
const storageName = '@settings';
class SettingsClient extends WithBootedClient_1$1.default {
    constructor() {
        super(...arguments);
        this.state = {};
    }
    ...
    set(name, value) {
        const newState = Object.assign(Object.assign({}, this.state), { [name]: value });
        this.setState(newState);
...
Settings.default = new SettingsClient();
 ...
 */
function iterate$5(list, iterator, state, callback)
{
  // store current index
...
function parallel(list, iterator, callback)
{
  ...
  {
    iterate$4(list, iterator, state, function(error, result)
    {
      if (error)
      {
...
function serialOrdered$1(list, iterator, sortMethod, callback)
{
  ...
  iterate$3(list, iterator, state, function iteratorHandler(error, result)
  {
    if (error)
    {
      callback(error, result);
    ...
    {
      iterate$3(list, iterator, state, iteratorHandler);
      return;
    }
...
const util = require$$1$2;
const followRedirects = followRedirects$1.exports;
...
Object.defineProperty(RESTClient$1, "__esModule", { value: true });
const tslib_1 = require$$0$1;
const axios_1 = axios_1$1;
const IAM_1$1 = IAM$1;
class RESTClient {
    constructor(config) {
        ...
        this.axios.interceptors.request.use((config) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!config) {
                return config;
            }
            if (!config.headers) {
            ...
            const user = IAM_1$1.User.fromCache();
            if (!user) {
                return config;
            }
        ...
        this.axios.interceptors.response.use((response) => response, function (error) {
            ...
            switch (error.response.status) {
                case 401:
                    if (IAM_1$1.default.isAuthenticated()) {
                        IAM_1$1.default.getUser().signOut();
                    }
...
RESTClient$1.default = RESTClient;

Object.defineProperty(clients, "__esModule", { value: true });
clients.WithBootedClient = clients.RESTClient = clients.Settings = clients.IAM = void 0;
const IAM_1 = IAM$1;
clients.IAM = IAM_1.default;
const Settings_1 = Settings;
clients.Settings = Settings_1.default;
const RESTClient_1 = RESTClient$1;
clients.RESTClient = RESTClient_1.default;
const WithBootedClient_1 = WithBootedClient$1;
clients.WithBootedClient = WithBootedClient_1.default;

Object.defineProperty(src$1, "__esModule", { value: true });
var Clients_1 = src$1.Clients = src$1.Models = Lib_1 = src$1.Lib = void 0;
const Lib = lib;
var Lib_1 = src$1.Lib = Lib;
const Models = models;
src$1.Models = Models;
const Clients = clients;
Clients_1 = src$1.Clients = Clients;
...
const Login$1 = props => {
  const onAuthenticatedHandler = authData => __awaiter(void 0, void 0, void 0, function* () {
    Clients_1.IAM.authenticate(authData);
    props.onAuthenticated();
  });
  const onLoginHandler = provider => {
    // TODO:
    // that config url come from the Module Hoster
    const SSO_API_BASE_URL = 'http://localhost:8080';
    const loginUrl = `${SSO_API_BASE_URL}/oauth2/${CLIENT_ID}/authorize/${provider}?response_type=token&prompt=login&redirect_uri=${SSO_API_BASE_URL}/oauth2/callback`;
    Lib_1.Expr.whenNotInNativePhone(() => {
    ...
    Lib_1.Expr.whenInNativePhone(() => __awaiter(void 0, void 0, void 0, function* () {
...
const BASE_URL$3 = 'http://localhost:8090';
class Approval$2 extends Clients_1.RESTClient {
  get(id) {
...
const BASE_URL$2 = 'http://localhost:8090';
class User extends Clients_1.RESTClient {
...
const BASE_URL$1 = 'http://localhost:8090';
class Role extends Clients_1.RESTClient {
...
class Section extends Clients_1.RESTClient {
  getAll(country, flag, store) {
    return __awaiter(this, void 0, void 0, function* () {
...
var constants = {
  SCOPE_KEY_FLAG: 'flag',
  SCOPE_KEY_STORE: 'store',
  SCOPE_KEY_ROL: 'rol',
  SCOPE_KEY_SECTION: 'section'
};
...
const thereAreChanges$1 = (approval, draft) => {
  ...
  if (!thereAreChanges) {
    const userSections = ((approval === null || approval === void 0 ? void 0 : approval.user.scopes) || []).filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
    const draftSections = ((draft === null || draft === void 0 ? void 0 : draft.user.scopes) || []).filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
...
const Update = () => {
  ...
  const selectedSections = context.draft.user.scopes.filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
  const rolesText = context.draft.user.roles.reduce((text, role, index, array) => {
    const match = roles.find(o => o.id === role);
  ...
  return jsxs(Ramen.XPage, {
    children: [jsx(Ramen.XHeader, {
      ...
      children: [jsx(Ramen.XButton, {
        ...
        disabled: !(selectedRoles.length > 0 && selectedSections.length > 0),
...
const Roles$1 = () => {
  ...
  const onChangeSelectionHandler = options => {
    ...
    const newRoles = options.map(option => option.value);
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        setDraft(Object.assign(Object.assign({}, draft), {
          user: Object.assign(Object.assign({}, draft.user), {
            roles: draft.user.roles.filter(role => role !== (pendingToRemove === null || pendingToRemove === void 0 ? void 0 : pendingToRemove.id))
          })
        }));
      }
    }, 400);
  ...
  const selection = ((draft === null || draft === void 0 ? void 0 : draft.user.roles) || []).map(role => {
    const match = location.state.roles.find(r => r.id === role);
    return {
      id: role,
  ...
  return jsxs(Ramen.XPage, {
    children: [jsx(Ramen.XHeader, {
      ...
      children: [content, jsx(Ramen.XVSpace, {
        ...
        icon: "alert-bold-filled",
        title: `¿Seguro que quieres eliminar el rol "${pendingToRemove === null || pendingToRemove === void 0 ? void 0 : pendingToRemove.id}"?`,
        actions: [{
          key: 'remove',
          text: 'Eliminar',
          type: 'solid'
...
const Sections$1 = () => {
  ...
  const onChangeSelectionHandler = options => {
    ...
    const otherScopes = draft.user.scopes.filter(scope => !scope.startsWith(constants.SCOPE_KEY_SECTION));
    const newScopes = options.map(option => `${constants.SCOPE_KEY_SECTION}:${option.value}`);
    setDraft(Object.assign(Object.assign({}, draft), {
      user: Object.assign(Object.assign({}, draft.user), {
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        setDraft(Object.assign(Object.assign({}, draft), {
          user: Object.assign(Object.assign({}, draft.user), {
            scopes: draft.user.scopes.filter(scope => scope !== `${constants.SCOPE_KEY_SECTION}:${pendingToRemove === null || pendingToRemove === void 0 ? void 0 : pendingToRemove.id}`)
          })
        }));
      }
    }, 400);
  ...
  if (!draft) return jsx(Ramen.XPage, {});
  const selection = ((draft === null || draft === void 0 ? void 0 : draft.user.scopes) || []).filter(role => role.startsWith(constants.SCOPE_KEY_SECTION)).map(role => {
...
const TwoSections$1 = () => {
  ...
  const onChangeSelectionHandler = options => {
    ...
    options.forEach(option => {
      option.subOptions.forEach(subOption => {
        newScopes.push(`${constants.SCOPE_KEY_SECTION}:${option.id}:${subOption.id}`);
      });
    });
    setDraft(Object.assign(Object.assign({}, draft), {
      user: Object.assign(Object.assign({}, draft.user), {
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        const otherScope = draft.user.scopes.filter(scope => !scope.startsWith(constants.SCOPE_KEY_SECTION));
        const newScope = [];
        newSelection.forEach(option => {
          option.subOptions.forEach(subOption => {
            newScope.push(`${constants.SCOPE_KEY_SECTION}:${option.id}:${subOption.id}`);
          });
        });
        setDraft(Object.assign(Object.assign({}, draft), {
          user: Object.assign(Object.assign({}, draft.user), {
  ...
  if (!draft) return jsx(Ramen.XPage, {});
  const selection = [];
  ((draft === null || draft === void 0 ? void 0 : draft.user.scopes) || []).filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION)).forEach(scope => {
    const parts = scope.split(':');
    const sectionId = parts[1];
    const twoSectionId = parts[2];
...
const Approval$1 = props => {
  ...
  return jsx(Context$1, Object.assign({
    ...
    children: jsxs(Switch, {
      children: [jsx(Route, {
        path: withBasePath('/:taskId'),
        exact: true,
        component: Update
      }), jsx(Route, {
        path: withBasePath('/:taskId/update/roles'),
        exact: true,
        component: Roles$1
      }), jsx(Route, {
        path: withBasePath('/:taskId/update/sections'),
        exact: true,
        component: Sections$1
      }), jsx(Route, {
        path: withBasePath('/:taskId/update/two-sections'),
        exact: true,
...
const logger$1 = Lib_1.ChariotConsole({
  label: 'Users'
});
const Users$1 = () => {
  const history = Router.useHistory();
...
const logger = Lib_1.ChariotConsole({
  label: 'Update User'
});
const thereAreChanges = (user, draft) => {
  let thereAreChanges = false;
  ...
  // Check diferences in sections
  if (!thereAreChanges) {
    const userSections = user.scopes.filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
    const draftSections = ((draft === null || draft === void 0 ? void 0 : draft.scopes) || []).filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
    if (userSections.length !== draftSections.length) {
      thereAreChanges = true;
    }
    if (!thereAreChanges) {
...
const UpdateTask = () => {
  ...
  // Draft is used to keep editions in memory
  React.useEffect(() => {
    const conditions = [draft === null, location.state.user.identifier !== (draft === null || draft === void 0 ? void 0 : draft.identifier), thereAreChanges(location.state.user, draft) && history.action === 'PUSH'];
  ...
  React.useEffect(() => {
    const newRoles = ((draft === null || draft === void 0 ? void 0 : draft.roles) || []).reduce((text, role, index, array) => {
      const match = location.state.roles.find(o => o.id === role);
      const label = (match === null || match === void 0 ? void 0 : match.label) || role.toUpperCase();
      let newText = `${text}${label}`;
      if (index !== array.length - 1) {
        newText = `${newText}, `;
    ...
    setRoles(newRoles);
  }, [location.state.roles, draft === null || draft === void 0 ? void 0 : draft.roles]);
  if (!draft) return jsx(Ramen.XPage, {});
  const scopes = [{
    id: 'roles',
    label: 'Roles'
  ...
  const selectedSections = draft.scopes.filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION));
  return jsxs(Ramen.XPage, {
    children: [jsx(Ramen.XHeader, {
      onBack: onGoBackHandler
    }), jsxs(Ramen.XBody, {
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        setDraft(Object.assign(Object.assign({}, draft), {
          roles: draft.roles.filter(role => role !== (pendingToRemove === null || pendingToRemove === void 0 ? void 0 : pendingToRemove.id))
        }));
      }
    }, 400);
  };
...
const Sections = () => {
  ...
  const onChangeSelectionHandler = options => {
    ...
    const otherScopes = draft.scopes.filter(scope => !scope.startsWith(constants.SCOPE_KEY_SECTION));
    const newScopes = options.map(option => `${constants.SCOPE_KEY_SECTION}:${option.value}`);
    setDraft(Object.assign(Object.assign({}, draft), {
      scopes: [...otherScopes, ...newScopes]
    }));
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        setDraft(Object.assign(Object.assign({}, draft), {
          scopes: draft.scopes.filter(scope => scope !== `${constants.SCOPE_KEY_SECTION}:${pendingToRemove === null || pendingToRemove === void 0 ? void 0 : pendingToRemove.id}`)
        }));
      }
    }, 400);
  };
  ...
  if (!draft) return jsx(Ramen.XPage, {});
  const selection = ((draft === null || draft === void 0 ? void 0 : draft.scopes) || []).filter(role => role.startsWith(constants.SCOPE_KEY_SECTION)).map(role => {
    const parts = role.split(':');
    const id = parts[1];
    const match = location.state.sections.find(section => section.id === id);
    return {
...
const TwoSections = () => {
  ...
  const onRemoveConfirmActionClickHandler = action => {
    ...
    setTimeout(() => {
      if (action === 'remove') {
        ...
        const otherScope = draft.scopes.filter(scope => !scope.startsWith(constants.SCOPE_KEY_SECTION));
        const newScope = [];
        newSelection.forEach(option => {
          option.subOptions.forEach(subOption => {
            newScope.push(`${constants.SCOPE_KEY_SECTION}:${option.id}:${subOption.id}`);
  ...
  if (!draft) return jsx(Ramen.XPage, {});
  const selection = [];
  ((draft === null || draft === void 0 ? void 0 : draft.scopes) || []).filter(scope => scope.startsWith(constants.SCOPE_KEY_SECTION)).forEach(scope => {
    const parts = scope.split(':');
    const sectionId = parts[1];
    const twoSectionId = parts[2];
    let match = selection.find(option => option.id === sectionId);
