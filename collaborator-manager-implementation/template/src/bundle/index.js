...
class CollaboratorManagePage extends Page {
  constructor() {
    super(...arguments);
    this.state = {};
  }
...
class CollaboratorManagerModule extends Module {
  constructor(props, override) {
    super(props, {
      routes: [{
        path: '/',
        page: CollaboratorManagePage
      }],
      override
    });
  }
}
CollaboratorManagerModule.route = '/collaborator-manager';

export { CollaboratorManagerModule as default };
