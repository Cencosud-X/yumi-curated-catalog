...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$l(fn = input.toString) && !isObject$b(val = call$n(fn, input))) return val;
  if (isCallable$l(fn = input.valueOf) && !isObject$b(val = call$n(fn, input))) return val;
  if (pref !== 'string' && isCallable$l(fn = input.toString) && !isObject$b(val = call$n(fn, input))) return val;
...
var CONFIGURABLE_LENGTH = DESCRIPTORS$9 && !fails$n(function () {
...
var isForced$2 = function (feature, detection) {
  ...
  return value == POLYFILL ? true
    : value == NATIVE ? false
    : isCallable$g(detection) ? fails$m(detection)
    : !!detection;
};
...
var functionUncurryThisAccessor = function (object, key, method) {
  try {
    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
    return uncurryThis$m(aCallable$8(Object.getOwnPropertyDescriptor(object, key)[method]));
  } catch (error) { /* empty */ }
};
...
var repeat$1 = uncurryThis$j($repeat$1);
...
$$d({ target: 'Number', proto: true, forced: FORCED$2 }, {
  toFixed: function toFixed(fractionDigits) {
    ...
    if (fractDigits < 0 || fractDigits > 20) throw $RangeError$3('Incorrect fraction digits');
    // eslint-disable-next-line no-self-compare -- NaN check
...
var UNSUPPORTED_Y$1 = fails$g(function () {
  var re = $RegExp$2('a', 'y');
  re.lastIndex = 2;
...
var MISSED_STICKY = UNSUPPORTED_Y$1 || fails$g(function () {
  return !$RegExp$2('a', 'y').sticky;
});

var BROKEN_CARET = UNSUPPORTED_Y$1 || fails$g(function () {
...
fixRegExpWellKnownSymbolLogic$2('search', function (SEARCH, nativeSearch, maybeCallNative) {
  return [
    ...
    function search(regexp) {
      ...
      return searcher ? call$g(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$7(O));
    },
...
var urlConstructorDetection = !fails$c(function () {
  ...
  return (IS_PURE && !url.toJSON)
    || (!searchParams.size && (IS_PURE || !DESCRIPTORS$6))
    || !searchParams.sort
...
var getIterator$3 = function (argument, usingIterator) {
  ...
  if (aCallable$5(iteratorMethod)) return anObject$9(call$f(iteratorMethod, argument));
...
var safeGetBuiltIn = function (name) {
  if (!DESCRIPTORS$5) return global$f[name];
  var descriptor = getOwnPropertyDescriptor$1(global$f, name);
...
var encodeURIComponent = global$f.encodeURIComponent;
  ...
  parseObject: function (object) {
    ...
    if (iteratorMethod) {
      ...
      while (!(step = call$e(next, iterator)).done) {
        entryIterator = getIterator$2(anObject$8(step.value));
...
var URLSearchParamsConstructor = function URLSearchParams(/* init */) {
  ...
  if (!DESCRIPTORS$5) this.length = state.entries.length;
};
...
defineBuiltIns$1(URLSearchParamsPrototype, {
  ...
  'delete': function (name) {
    ...
    if (!DESCRIPTORS$5) this.length = entries.length;
    state.updateURL();
  },
...
if (DESCRIPTORS$5) defineBuiltInAccessor$5(URLSearchParamsPrototype, 'size', {
  get: function size() {
...
if (!USE_NATIVE_URL && isCallable$9(Headers)) {
  ...
  return [
    ...
    function (string, replaceValue) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        var position = max(min(toIntegerOrInfinity$3(result.index), S.length), 0);
        var captures = [];
...
if (!set$1 || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$6(global$e.postMessage) &&
...
if (!microtask$1) {
  ...
  // - setTimeout
    ...
    macrotask = bind$4(macrotask, global$d);
    notify$1 = function () {
      macrotask(flush);
    };
  }
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$5(global$b.PromiseRejectionEvent);
...
var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$2 && classof$4(global$8.opera) !== 'Opera';
...
if (DESCRIPTORS$2 && !hasOwn$3(TypedArrayPrototype$1, TO_STRING_TAG)) {
