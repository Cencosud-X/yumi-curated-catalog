(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SpikeModule = {}, global.jsxRuntime, global.react, global.React, global.reactRouterDom));
    ...
    */
    ...
    var CategoriesPage = /** @class */function (_super) {
      ...
      function CategoriesPage() {
        ...
        _this.onClickCategory = function (category) {
          ...
          // Default behavior
          _this.props.history.push("/found-rate/category/".concat(category));
        };
        _this.render = function () {
          var view = _this.state.view;
          return jsxRuntime.jsx("div", {
            children: function () {
              var customRender = _this["render_".concat(view)];
              if (!customRender) {
                return jsxRuntime.jsx("div", {
                  children: view
                }, void 0);
        ...
        _this.render_LOADING = function () {
          return jsxRuntime.jsx(react.IonPage, {
            children: jsxRuntime.jsx(react.IonContent, {
              children: jsxRuntime.jsx(react.IonSpinner, {}, void 0)
            }, void 0)
          }, void 0);
        };
        _this.render_ERROR = function () {
          return jsxRuntime.jsx(react.IonPage, {
            children: jsxRuntime.jsx(react.IonContent, {
        ...
        _this.render_LIST = function () {
          ...
          return jsxRuntime.jsxs(react.IonPage, {
            children: [jsxRuntime.jsx(react.IonHeader, {
              children: jsxRuntime.jsxs(react.IonToolbar, {
                children: [jsxRuntime.jsx(react.IonButtons, __assign({
                  slot: "start"
                }, {
                  children: jsxRuntime.jsx(react.IonBackButton, {}, void 0)
                }), void 0), jsxRuntime.jsx(react.IonTitle, {
                  children: "Categories"
                }, void 0)]
              }, void 0)
            }, void 0), jsxRuntime.jsxs(react.IonContent, {
              children: [jsxRuntime.jsx(react.IonList, {
                children: categories.map(function (category) {
                  return jsxRuntime.jsx(react.IonItem, __assign({
                    onClick: function () {
                      return _this.onClickCategory(category);
                    }
                  }, {
                    children: jsxRuntime.jsx(react.IonLabel, {
                      children: category
                    }, void 0)
                  }), category);
                })
      ...
      function ProductListPage(props) {
        ...
        _this.componentDidMount = function () {
          setTimeout(function () {
            _this.setState({
              view: 'LIST',
              products: ['Coca Cola', 'Pisco', 'Hielo']
            });
          }, 1000);
        };
            ...
            children: [jsxRuntime.jsx(react.IonHeader, {
              children: jsxRuntime.jsxs(react.IonToolbar, {
                children: [jsxRuntime.jsx(react.IonButtons, __assign({
                  ...
                  children: "".concat(match.params.category, " products")
                }, void 0)]
              }, void 0)
            }, void 0), jsxRuntime.jsxs(react.IonContent, {
              children: [jsxRuntime.jsx(react.IonList, {
                children: products.map(function (product) {
                  return jsxRuntime.jsx(react.IonItem, {
                    children: jsxRuntime.jsx(react.IonLabel, {
                      children: product
                    }, void 0)
                  }, product);
                })
              }, void 0), jsxRuntime.jsx(react.IonButton, __assign({
    ...
    var SubcategoriesPage = /** @class */function (_super) {
      __extends(SubcategoriesPage, _super);
      function SubcategoriesPage() {
        ...
        _this.render_LIST = function () {
          ...
          var subcategories = _this.state.subcategories;
          return jsxRuntime.jsxs(react.IonPage, {
            children: [jsxRuntime.jsx(react.IonHeader, {
              children: jsxRuntime.jsxs(react.IonToolbar, {
                children: [jsxRuntime.jsx(react.IonButtons, __assign({
            ...
            }, void 0), jsxRuntime.jsx(react.IonContent, {
              children: jsxRuntime.jsx(react.IonList, {
                children: subcategories.map(function (subcategory) {
                  return jsxRuntime.jsx(react.IonItem, __assign({
                    onClick: function () {
                      return history.push("/found-rate/products/".concat(subcategory));
                    }
                  }, {
                    children: jsxRuntime.jsx(react.IonLabel, {
    ...
    var FoundRateModule = /** @class */function (_super) {
      __extends(FoundRateModule, _super);
      function FoundRateModule(props, override) {
      ...
      FoundRateModule.route = "/found-rate";
      return FoundRateModule;
    }(Module);

    exports.FoundRateModule = FoundRateModule;
