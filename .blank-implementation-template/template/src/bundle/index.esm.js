...
import { IonRouterOutlet, IonPage, IonContent, IonSpinner, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonList, IonItem, IonLabel, IonButton } from '@ionic/react';
...
class CategoriesPage extends Page {
  constructor() {
    ...
    this.onClickCategory = category => {
      ...
      // Default behavior
      this.props.history.push(`/found-rate/category/${category}`);
    };
    this.render = () => {
      const {
        view
      ...
      return jsx("div", {
        children: (() => {
          const customRender = this[`render_${view}`];
          if (!customRender) {
            return jsx("div", {
              children: view
            }, void 0);
    ...
    this.render_LOADING = () => {
      return jsx(IonPage, {
        children: jsx(IonContent, {
          children: jsx(IonSpinner, {}, void 0)
        }, void 0)
      }, void 0);
    };
    this.render_ERROR = () => {
    ...
    this.render_LIST = () => {
      ...
      return jsxs(IonPage, {
        children: [jsx(IonHeader, {
          children: jsxs(IonToolbar, {
            children: [jsx(IonButtons, Object.assign({
              slot: "start"
            }, {
              children: jsx(IonBackButton, {}, void 0)
            }), void 0), jsx(IonTitle, {
              children: "Categories"
            }, void 0)]
          }, void 0)
        }, void 0), jsxs(IonContent, {
          children: [jsx(IonList, {
            children: categories.map(category => jsx(IonItem, Object.assign({
              onClick: () => this.onClickCategory(category)
            }, {
              children: jsx(IonLabel, {
                children: category
              }, void 0)
            }), category))
        ...
        children: [jsx(IonHeader, {
          children: jsxs(IonToolbar, {
            children: [jsx(IonButtons, Object.assign({
              ...
              children: `${match.params.category} products`
            }, void 0)]
          }, void 0)
        }, void 0), jsxs(IonContent, {
          children: [jsx(IonList, {
            children: products.map(product => jsx(IonItem, {
              children: jsx(IonLabel, {
                children: product
              }, void 0)
            }, product))
          }, void 0), jsx(IonButton, Object.assign({
...
class SubcategoriesPage extends Page {
  constructor() {
    super(...arguments);
    this.state = {
      view: 'LOADING',
    ...
    this.render_LIST = () => {
      ...
      return jsxs(IonPage, {
        ...
        }, void 0), jsx(IonContent, {
          children: jsx(IonList, {
            children: subcategories.map(subcategory => jsx(IonItem, Object.assign({
              onClick: () => history.push(`/found-rate/products/${subcategory}`)
            }, {
              children: jsx(IonLabel, {
...
class FoundRateModule extends Module {
