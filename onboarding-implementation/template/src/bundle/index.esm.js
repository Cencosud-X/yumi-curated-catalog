...
var styles$2 = {"root":"index-module_root__T0nnT","root__content":"index-module_root__content__t7g-M","image":"index-module_image__ySeUo","image__src":"index-module_image__src__RN1zr","texts":"index-module_texts__JS0-W","texts__title":"index-module_texts__title__iZ1WA","texts__subtitle":"index-module_texts__subtitle__kEquS","button":"index-module_button__tAqIx","button__text":"index-module_button__text__N6MjE"};

class BaseWelcome extends BasePage {
  constructor() {
    super(...arguments);
    ...
    this.render = () => {
      return jsxs(IonPage, Object.assign({
        ...
        children: [jsxs(IonContent, Object.assign({
          ...
          children: jsx(IonButton, Object.assign({
            ...
            onClick: this.onStartClickHandler
          }, {
            children: jsx(IonText, Object.assign({
      ...
      return jsxs(IonPage, Object.assign({
        ...
        children: [jsxs(IonContent, Object.assign({
          ...
          children: jsx(IonButton, Object.assign({
            ...
            onClick: this.onActivateLocalizationClickHandler
          }, {
            children: jsx(IonText, Object.assign({
...
var styles = {"root":"index-module_root__n6S-J","root__content":"index-module_root__content__jjDi-","image":"index-module_image__NfbA9","image__src":"index-module_image__src__LtTdv","texts":"index-module_texts__ELsc3","texts__title":"index-module_texts__title__HjPzk","texts__subtitle":"index-module_texts__subtitle__ZVUvA","button":"index-module_button__J-z-U","button__text":"index-module_button__text__J9hXg"};

class BaseNotification extends BasePage {
  constructor() {
    super(...arguments);
    this.onActivateNotificationClickHandler = () => {
      // our logic here
      this.next();
    };
    this.render = () => {
      return jsxs(IonPage, Object.assign({
        ...
        children: [jsxs(IonContent, Object.assign({
          ...
          children: jsx(IonButton, Object.assign({
            ...
            onClick: this.onActivateNotificationClickHandler
          }, {
            children: jsx(IonText, Object.assign({
...
export { index as Lib, OnBoardingModule as default };
