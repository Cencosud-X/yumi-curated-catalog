(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionic/react/css/ionic-swiper.css'), require('swiper/css'), require('react/jsx-runtime'), require('@ionic/react'), require('react'), require('react-router-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', '@ionic/react/css/ionic-swiper.css', 'swiper/css', 'react/jsx-runtime', '@ionic/react', 'react', 'react-router-dom'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OnboardingSource = {}, null, null, global.jsxRuntime, global.react, global.React, global.reactRouterDom));
})(this, (function (exports, ionicSwiper_css, css, jsxRuntime, react, React, reactRouterDom) { 'use strict';
	...
	***************************************************************************** */
	...
	var colorGray$1 = 'rgba(0,0,0,0.6)';
	var stylePage$1 = {
	  backgroundImage: "url(".concat(img$2, ")")
	};
	var BaseOnboardingPage = /** @class */function (_super) {
	  __extends(BaseOnboardingPage, _super);
	  function BaseOnboardingPage(props, params) {
	    var _this = _super.call(this, props) || this;
	    _this.state = {};
	    _this.onNextButtonClickHandler = function () {
	        ...
	        children: [jsxRuntime.jsxs(react.IonContent, {
	          children: [jsxRuntime.jsx("div", __assign({
	            ...
	            children: [jsxRuntime.jsx(react.IonText, __assign({
	              ...
	              children: _this.params.title
	            }), void 0), jsxRuntime.jsx(react.IonText, __assign({
	              color: "black",
	              className: 'subtitle'
	            }, {
	              children: _this.params.subtitle
	            }), void 0)]
	          }), void 0)]
	          ...
	          children: jsxRuntime.jsx(react.IonButton, __assign({
	            ...
	            expand: "block",
	            size: 'large',
	            onClick: _this.onNextButtonClickHandler
	          }, {
	            children: jsxRuntime.jsx(react.IonText, __assign({
	              className: 'button-text',
	              onClick: _this.params.onActionClickHandler
	            }, {
	              children: _this.params.actionText
	            }), void 0)
	          }), void 0)
	        }), void 0)]
	      }), void 0);
	...
	var GeolocalizationPage = /** @class */function (_super) {
	  __extends(GeolocalizationPage, _super);
	  function GeolocalizationPage(props) {
	...
	var OnBoardingModule = /** @class */function (_super) {
	  ...
	  function OnBoardingModule(props, override) {
	    ...
	    _this.onChangeToNextPageHandler = function () {
	      var _a;
	      _this.pageIndex += 1;
	      var totalPages = ((_a = _this.override.routes) === null || _a === void 0 ? void 0 : _a.length) || 0;
	      if (totalPages === _this.pageIndex) {
	        _this.onFinalize();
	        return;
	      }
	      var currentPage = _this.override.routes[_this.pageIndex];
	      _this.props.history.push("".concat(_this.props.match.url).concat(currentPage.path));
	    };
	    _this.override = override;
	    EventStreamer$1.on("PAGE:NEXT", _this.onChangeToNextPageHandler);
	    return _this;
	  }
	  OnBoardingModule.prototype.onFinalize = function () {
