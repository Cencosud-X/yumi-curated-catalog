...
fixRegExpWellKnownSymbolLogic$1('match', function (MATCH, nativeMatch, maybeCallNative) {
  return [
    ...
    function match(regexp) {
      ...
      return matcher ? call$4(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$3(O));
    },
...
class RESTClient {
  constructor(config) {
    ...
    this.axios.interceptors.request.use(config => __awaiter(this, void 0, void 0, function* () {
      ...
      const auth = yield this.getAuthFromCache();
      const jwt = auth.user;
      // TODO: fix this
...
class ModuleClient extends RESTClient {
  /**
...
const ModuleClientInstnace = new ModuleClient({
  baseURL: 'https://api.staging.cencox.xyz/internal-consumption-module/internal-consumption-bff'
});

const checkModuleAccess = () => __awaiter(void 0, void 0, void 0, function* () {
  const hour = moment().tz('America/Santiago').hour();
...
const ToolPageWrapper = props => {
  ...
  // const [alertMsg, setAlertMsg] = useState<{ text: string, type: string }>();
  ...
  const loadCostCeners = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield ModuleClientInstnace.getCostCenters();
    setLoading(false);
    setCostCenters(data);
  });
