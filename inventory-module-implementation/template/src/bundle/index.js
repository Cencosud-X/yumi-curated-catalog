...
import React__default, { useEffect, useRef, Fragment, useState, createContext, useContext } from 'react';
...
var functionBindNative$1 = !fails$y(function () {
...
var uncurryThisWithBind$1 = NATIVE_BIND$4 && FunctionPrototype$4.bind.bind(call$k, call$k);
...
var stringSlice$9 = uncurryThis$v(''.slice);
...
var defineGlobalProperty$7 = function (key, value) {
  try {
    defineProperty$d(global$t, key, { value: value, configurable: true, writable: true });
  } catch (error) {
    global$t[key] = value;
  } return value;
};
...
var hasOwnProperty_1$1 = Object.hasOwn || function hasOwn(it, key) {
  return hasOwnProperty$2(toObject$7(it), key);
};
...
var symbolConstructorDetection$1 = !!Object.getOwnPropertySymbols && !fails$w(function () {
  var symbol = Symbol();
...
var v8PrototypeDefineBug$1 = DESCRIPTORS$l && fails$u(function () {
  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var ie8DomDefine$1 = !DESCRIPTORS$k && !fails$t(function () {
  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var functionCall$1 = NATIVE_BIND$3 ? call$j.bind(call$j) : function () {
...
var ordinaryToPrimitive$3 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$t(fn = input.toString) && !isObject$h(val = call$i(fn, input))) return val;
  if (isCallable$t(fn = input.valueOf) && !isObject$h(val = call$i(fn, input))) return val;
  if (pref !== 'string' && isCallable$t(fn = input.toString) && !isObject$h(val = call$i(fn, input))) return val;
...
if (ArrayPrototype$1[UNSCOPABLES$1] == undefined) {
  defineProperty$c(ArrayPrototype$1, UNSCOPABLES$1, {
    configurable: true,
    value: create$5(null)
  });
}
...
objectGetOwnPropertyDescriptor$1.f = DESCRIPTORS$g ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
  O = toIndexedObject$7(O);
  P = toPropertyKey$3(P);
  if (IE8_DOM_DEFINE$2) try {
    return $getOwnPropertyDescriptor$2(O, P);
  } catch (error) { /* empty */ }
  if (hasOwn$g(O, P)) return createPropertyDescriptor$5(!call$g(propertyIsEnumerableModule$3.f, O, P), O[P]);
};
...
var CONFIGURABLE_LENGTH$1 = DESCRIPTORS$e && !fails$s(function () {
...
var makeBuiltIn$5 = makeBuiltIn$6.exports = function (value, name, options) {
  ...
  if (!hasOwn$e(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$3 && value.name !== name)) {
    if (DESCRIPTORS$e) defineProperty$b(value, 'name', { value: name, configurable: true });
  ...
  try {
    if (options && hasOwn$e(options, 'constructor') && options.constructor) {
      if (DESCRIPTORS$e) defineProperty$b(value, 'prototype', { writable: false });
...
var NEW_ITERATOR_PROTOTYPE$1 = !isObject$e(IteratorPrototype$5) || fails$p(function () {
  var test = {};
...
var functionUncurryThisAccessor$1 = function (object, key, method) {
  try {
    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
    return uncurryThis$m(aCallable$3(Object.getOwnPropertyDescriptor(object, key)[method]));
  } catch (error) { /* empty */ }
};
...
var iteratorDefine$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if (DEFAULT) {
    ...
    } else $$8({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS$2 || INCORRECT_VALUES_NAME }, methods);
  }
...
// V8 ~ Chrome 45- bug
if (DESCRIPTORS$d && values$1.name !== 'values') try {
...
var objectAssign$1 = !$assign$1 || fails$o(function () {
  // should have correct order of operations (Edge bug)
  if (DESCRIPTORS$c && $assign$1({ b: 1 }, $assign$1(defineProperty$8({}, 'a', {
    enumerable: true,
    get: function () {
...
var UNSUPPORTED_Y$4 = fails$n(function () {
  var re = $RegExp$5('a', 'y');
  re.lastIndex = 2;
...
var MISSED_STICKY$2 = UNSUPPORTED_Y$4 || fails$n(function () {
  return !$RegExp$5('a', 'y').sticky;
});

var BROKEN_CARET$1 = UNSUPPORTED_Y$4 || fails$n(function () {
...
var regexpUnsupportedDotAll$1 = fails$m(function () {
  var re = $RegExp$4('.', 's');
...
var regexpUnsupportedNcg$1 = fails$l(function () {
...
var UPDATES_LAST_INDEX_WRONG$1 = (function () {
  var re1 = /a/;
  var re2 = /b*/g;
  call$d(nativeExec$1, re1, 'a');
  call$d(nativeExec$1, re2, 'a');
...
if (PATCH$1) {
  patchedExec$1 = function exec(string) {
    ...
    if (raw) {
      ...
      result = call$d(patchedExec$1, raw, str);
    ...
    var flags = call$d(regexpFlags$2, re);
    ...
    match = call$d(nativeExec$1, sticky ? reCopy : re, strCopy);
    ...
    if (NPCG_INCLUDED$1 && match && match.length > 1) {
      ...
      call$d(nativeReplace$1, match[0], reCopy, function () {
...
var functionUncurryThisClause = function (fn) {
  ...
  if (classofRaw$2(fn) === 'Function') return uncurryThis$j(fn);
};
...
fixRegExpWellKnownSymbolLogic$1('match', function (MATCH, nativeMatch, maybeCallNative) {
  return [
    ...
    function match(regexp) {
      ...
      return matcher ? call$b(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$8(O));
    },
...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$2 ? call$a.bind(apply$1) : function () {
...
var defineProperty$6 = objectDefineProperty$1;
...
var setSpecies$1 = function (CONSTRUCTOR_NAME) {
  ...
  if (DESCRIPTORS$b && Constructor && !Constructor[SPECIES]) {
...
var BASE_FORCED = DESCRIPTORS$a &&
  (!CORRECT_NEW || MISSED_STICKY$1 || UNSUPPORTED_DOT_ALL$1 || UNSUPPORTED_NCG$1 || fails$h(function () {
    re2[MATCH$2] = false;
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$a(fn = input.toString) && !isObject$a(val = call$5(fn, input))) return val;
  if (isCallable$a(fn = input.valueOf) && !isObject$a(val = call$5(fn, input))) return val;
  if (pref !== 'string' && isCallable$a(fn = input.toString) && !isObject$a(val = call$5(fn, input))) return val;
...
var createWellKnownSymbol = USE_SYMBOL_AS_UID ? Symbol$4['for'] || Symbol$4 : Symbol$4 && Symbol$4.withoutSetter || uid$1;
...
const XPage = props => {
  const rootClass = classnames(Styles$3.xpage);
  const styles = {};
...
var Styles$2 = {"xheader":"root-module_xheader__yOmwG","xheader--sticky":"root-module_xheader--sticky__NvBQI","xheader-sticky_pinned":"root-module_xheader-sticky_pinned__L4UVF","xheader__bar":"root-module_xheader__bar__wsNwj","xheader__bar__back":"root-module_xheader__bar__back__6pCmW","xheader__bar__title":"root-module_xheader__bar__title__lhiT6","xheader__bar__tag_first":"root-module_xheader__bar__tag_first__Q2-tt","xheader__content":"root-module_xheader__content__8v5pl","header__content__title":"root-module_header__content__title__ScjPX"};

const XHeader = props => {
  const ref = React__default.useRef(null);
  const rootClass = classnames(Styles$2.xheader, {
    [Styles$2['xheader--sticky']]: props.sticky
  });
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      if (ref.current) {
        ...
        ref.current.classList.toggle(Styles$2['xheader-sticky_pinned'], origOffsetY >= targetStiky);
      }
    };
  ...
  return jsxs("div", {
    ...
    className: rootClass,
    children: [jsxs("div", {
      className: Styles$2.xheader__bar,
      children: [props.onBack && jsx("div", {
        onClick: onBackHandler,
        className: Styles$2.xheader__main__back,
        children: jsx(XIcon, {
          size: "s",
          icon: "arrow-left"
        })
      }), props.title && jsx("div", {
        className: Styles$2.xheader__bar__title,
        children: jsx(XText, {
          weight: "bold",
          fontSize: 9,
        ...
        const rootClass = classnames({
          [Styles$2.xheader__bar__tag_first]: index === 0 && array.length > 1
        });
      ...
      className: Styles$2.xheader__content,
      children: props.title && jsx("div", {
        className: Styles$2.header__content__title,
        children: jsx(XText, {
          weight: "bold",
          fontSize: 9,
          children: props.title
...
var NEW_ITERATOR_PROTOTYPE = !isObject$5(IteratorPrototype$2) || fails$1(function () {
  var test = {};
  // FF44- legacy iterators case
...
var isRegexp = function (it) {
  var isRegExp;
  return isObject$4(it) && ((isRegExp = it[MATCH$1]) !== undefined ? !!isRegExp : classof(it) == 'RegExp');
};
...
var Styles$1 = {"xbody":"root-module_xbody__uHrjP"};
...
var Styles = {"xfooter":"root-module_xfooter__TJjrb","xfooter--backround-solid":"root-module_xfooter--backround-solid__ATR-r","xfooter--backround-gradient":"root-module_xfooter--backround-gradient__yRrrr","xfooter--backround-transparent":"root-module_xfooter--backround-transparent__5eciF"};

const XFooter = props => {
  const rootClass = classnames(Styles.xfooter, {
    [Styles[`xfooter--backround-${props.background}`]]: props.background
  });
  return jsx("div", {
    className: rootClass,
    children: jsx(XBox, {
...
var index_mobile = Object.assign({}, Core, {
  XHeader,
  XBody,
  XFooter,
  XPage
    ...
    children: jsxs(IonItem, Object.assign({
      ...
      children: [jsx(IonThumbnail, Object.assign({
        ...
        children: [jsx(index_mobile.XText, Object.assign({
          ...
          children: props.title
        })), jsx(index_mobile.XBadge, {
          value: 20,
          size: "s"
        }), jsx(index_mobile.XIcon, {
          icon: "chevron-right",
          size: "s"
        })]
      }))]
